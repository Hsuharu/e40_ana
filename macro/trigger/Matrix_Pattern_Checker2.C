...
//  gStyle->SetOptStat(1111110); 
  ...
  TString pdf = Form("%s/pdf/trigger/Matrix_Pattern_Checker2_run%05d.pdf", anadir.Data(),runnum);
  TString pdf1 = Form("%s/pdf/trigger/Matrix_Pattern_Checker2_Check_run%05d.pdf", anadir.Data(),runnum);
