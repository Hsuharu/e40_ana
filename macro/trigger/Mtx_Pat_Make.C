...
void Mtx_Pat_Make(int month,int runnum, int bin){
...
//Reset ROOT and connect tree file
   ...
   TString pdf = Form("%s/pdf/trigger/Mtx_Pat_Make_bin%d_run%05d.pdf", anadir.Data(), bin,runnum);
   TString pdf1 = Form("%s/pdf/trigger/Mtx_Check_bin%d_run%05d.pdf", anadir.Data(), bin,runnum);
