...
//  TFile *f = new TFile(Form("%s/analyzer_%s/rootfile/run%05d_DstKuramaEasirocHodoscope.root", anadir.Data(),Month[month],runnum),"READ");
  ...
  Hist1[6 ]= new TH1D("vpseg[1]","vpseg[1]",NumOfSegSCH,0,NumOfSegSCH);
  ...
  Hist1[13]= new TH1D("vpseg[1] Cut1","vpseg[1] Cut1",NumOfSegSCH,0,NumOfSegSCH);
  ...
  Hist1[20]= new TH1D("vpseg[1] Cut2","vpseg[1] Cut2",NumOfSegSCH,0,NumOfSegSCH);
  Hist1[21]= new TH1D("TofSeg[0]","TofSeg[0]",NumOfSegTOF,0,NumOfSegTOF);
  Hist1[22]= new TH1D("TofSeg[0] Cut1","TofSeg[0] Cut1",NumOfSegTOF,0,NumOfSegTOF);
  Hist1[23]= new TH1D("TofSeg[0] Cut2","TofSeg[0] Cut2",NumOfSegTOF,0,NumOfSegTOF);
  ...
  Hist1[26]= new TH1D("tofsegKurama[0]","tofsegKurama[0]",NumOfSegTOF,0,NumOfSegTOF);
  Hist1[27]= new TH1D("tofsegKurama[0] Cut1","tofsegKurama[0] Cut1",NumOfSegTOF,0,NumOfSegTOF);
  Hist1[28]= new TH1D("tofsegKurama[0] Cut2","tofsegKurama[0] Cut2",NumOfSegTOF,0,NumOfSegTOF);
  Hist1[29]= new TH1D("vpseg[1] Cut3","vpseg[1] Cut3",NumOfSegSCH,0,NumOfSegSCH);
  Hist1[30]= new TH1D("TofSeg[0] Cut3","TofSeg[0] Cut3",NumOfSegTOF,0,NumOfSegTOF);
  Hist1[31]= new TH1D("tofsegKurama[0] Cut3","tofsegKurama[0] Cut3",NumOfSegTOF,0,NumOfSegTOF);
  ...
  Hist2[6 ]= new TH2D("TofSeg[0] % vpseg[1]","TofSeg[0] % vpseg[1]",NumOfSegSCH,0,NumOfSegSCH,NumOfSegTOF,0,NumOfSegTOF);
  Hist2[7 ]= new TH2D("TofSeg[0] % vpseg[1] Cut1","TofSeg[0] % vpseg[1] Cut1",NumOfSegSCH,0,NumOfSegSCH,NumOfSegTOF,0,NumOfSegTOF);
  Hist2[8 ]= new TH2D("TofSeg[0] % vpseg[1] Cut2","TofSeg[0] % vpseg[1] Cut2",NumOfSegSCH,0,NumOfSegSCH,NumOfSegTOF,0,NumOfSegTOF);
  Hist2[9 ]= new TH2D("Sch Position by HitSegment % vpx[1]","Sch Position by HitSegment % vpx[1]",200,-400,400,100,-400,400);
  Hist2[10]= new TH2D("tofsegKurama[0] % vpseg[1]","tofsegKurama[0] % vpseg[1]",NumOfSegSCH,0,NumOfSegSCH,NumOfSegTOF,0,NumOfSegTOF);
  Hist2[11]= new TH2D("tofsegKurama[0] % vpseg[1] Cut1","tofsegKurama[0] % vpseg[1] Cut1",NumOfSegSCH,0,NumOfSegSCH,NumOfSegTOF,0,NumOfSegTOF);
  Hist2[12]= new TH2D("tofsegKurama[0] % vpseg[1] Cut2","tofsegKurama[0] % vpseg[1] Cut2",NumOfSegSCH,0,NumOfSegSCH,NumOfSegTOF,0,NumOfSegTOF);
  Hist2[13]= new TH2D("TofSeg[0] % vpseg[1] Cut3","TofSeg[0] % vpseg[1] Cut3",NumOfSegSCH,0,NumOfSegSCH,NumOfSegTOF,0,NumOfSegTOF);
  Hist2[14]= new TH2D("tofsegKurama[0] % vpseg[1] Cut3","tofsegKurama[0] % vpseg[1] Cut3",NumOfSegSCH,0,NumOfSegSCH,NumOfSegTOF,0,NumOfSegTOF);
...
//      if(delta_x[i]<10 || delta_x[i]>25) continue;
  ...
  for(int i=0; i<Hist2Max; i++){
    Hist2[i]->Draw("colz");
    c1->Print(pdf);
    c1->Print(Form("%s/Mtx_Pos_run%05d_Hist2_colz_%03d.pdf",pdfDhire.Data(),runnum,i));
  }
