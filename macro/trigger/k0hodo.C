...
//Reset ROOT and connect tree file
   gROOT->Reset();
   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("analyzer_jun/rootfile/run05126_DstKuramaEasirocHodoscope.root");
   if (!f) {
      f = new TFile("analyzer_jun/rootfile/run05126_DstKuramaEasirocHodoscope.root");
   }
