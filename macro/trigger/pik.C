...
//     (Tue Jan 15 09:51:48 2019 by ROOT version6.10/08)
//   from TTree pik/tree of PiKAna
//   found on file: rootfile/run05126_DstPiKAna.root
//////////////////////////////////////////////////////////


//Reset ROOT and connect tree file
   gROOT->Reset();
   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("rootfile/run05126_DstPiKAna.root");
   if (!f) {
      f = new TFile("rootfile/run05126_DstPiKAna.root");
   }
