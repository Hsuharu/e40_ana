...
/////////////////////////////////////////////////////////////////////
  for(int i=0; i<NumOfSegBH1; i++){
    if(i<9){  
     BH1_U[i] = (TH1F*)file->Get(Form("h%d0%d0%d",BH1,i+1,TDC_U)) ; 
     BH1_D[i] = (TH1F*)file->Get(Form("h%d0%d0%d",BH1,i+1,TDC_D)) ; 
    }else{   
     BH1_U[i] = (TH1F*)file->Get(Form("h%d%d0%d",BH1,i+1,TDC_U))  ;
     BH1_D[i] = (TH1F*)file->Get(Form("h%d%d0%d",BH1,i+1,TDC_D))  ;
    }  
  }  
...
/////////////////////////////////////////////////////////////////////
  for(int i=0; i<NumOfSegBH2; i++){
    if(i<9){  
     BH2_U[i] =  (TH1F*)file->Get(Form("h%d0%d0%d",BH2,i+1,TDC_U)) ;
     BH2_D[i] =  (TH1F*)file->Get(Form("h%d0%d0%d",BH2,i+1,TDC_D)) ;
    }else{                                                        
     BH2_U[i] =  (TH1F*)file->Get(Form("h%d%d0%d",BH2,i+1,TDC_U))  ;
     BH2_D[i] =  (TH1F*)file->Get(Form("h%d%d0%d",BH2,i+1,TDC_D))  ;
    }  
  }  
...
//  }  
  ...
  TString fout1 = (Form( "%s/hp_dat/HDPRAM_BH1_U_TDC_%05d.dat", anadir.Data() ,runnum));  
  TString fout2 = (Form( "%s/hp_dat/HDPRAM_BH1_D_TDC_%05d.dat", anadir.Data() ,runnum));  
  ...
  TString fout3 = (Form( "%s/hp_dat/HDPRAM_BH2_U_TDC_%05d.dat", anadir.Data() ,runnum));  
  TString fout4 = (Form( "%s/hp_dat/HDPRAM_BH2_D_TDC_%05d.dat", anadir.Data() ,runnum));  
