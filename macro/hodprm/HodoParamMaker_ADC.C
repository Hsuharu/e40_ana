...
void HodoParamMaker_ADC(int runnum){
////////////////////////////////////////////////////////////
...
// TTreePlayer->SetBranchStatus("branchname",1);  // activate branchname
   ...
   TH1D *BTOF1[NumOfSegBH1]; 
      for (int i=0; i<NumOfSegBH1;i++) {
        ...
        BTOF1[i] = new TH1D(Form("BTOF1_%d",i+1),Form("BTOF1_%d",i+1),4000,-70,70);
      }
   ...
   TH1D *BTOF2[NumOfSegBH2]; 
      for (int i=0; i<NumOfSegBH2;i++) {
        ...
        BTOF2[i] = new TH1D(Form("BTOF2_%d",i+1),Form("BTOF2_%d",i+1),4000,-70,70);
      }
...
//     fout_1 << bh1utprm[i]  <<  "\t"  << bh1dtprm[i] << endl;
     fout_2 << bh1uaprm[i]  <<  "\t"  << bh1daprm[i] << endl;
//     fout_3 << bh1uamip[i]  <<  "\t"  << bh1damip[i] << endl;
